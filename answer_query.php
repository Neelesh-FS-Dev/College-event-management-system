...
<center> <h1><strong style="color:#000033;"> Answer Any Query! </strong> </h1><br> <br> 
        ...
        while($row = mysqli_fetch_array($result)) 
        {
          ?>
            <tr>
              ...
              <td><form method="post" action="answer_query_form.php">
                <input type="hidden" name="id" value="<?php echo $row['query_id']; ?>">
                <input type="hidden" name="query" value="<?php echo $row['query_ask']; ?>">
