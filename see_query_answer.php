...
<center> <h1><strong style="color:#000033;"> See Answers Here! </strong> </h1><br> <br> </center>
...
<?php 
if(isset($_POST['see_answer']))
{
  $ask_query = $_POST['query_value'];
  $id = $_POST['query_id'];
  ?>
  
  <div id="ev_w">
  <b>Query :</b><?php echo $ask_query; ?> <br><br>
  <b>Answers given by users<br><br></b>
  <?php

  $query = "SELECT * FROM query_answer_answer WHERE question_id = '$id'";
  ...
  if (mysqli_num_rows($result) > 0) 
      ...
      while($row = mysqli_fetch_array($result)) 
      {
        ?>
          <tr>
            ...
            <td> <?php echo $row['answer_user'];?></td>
          </tr>         
          <?php
          $count = $count + 1;
      }
    ...
    {
      ?>
      <table> <tr> <td><center> <h1><strong style="color:#000033;"> No Answers</strong></h1></center> </td></tr></table>
      <?php
    }
    echo "</div>";
