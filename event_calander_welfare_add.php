...
<?php
    ...
    if(isset($_POST['eadd']))
    {
       ...
       function alertmsg($alt_msg)
      {
       ...
       $query = "INSERT INTO event_calander(event_id, event_name, event_type, event_month, event_desc) VALUES('$eid', '$ename', '$etype', '$edate', '$edesc')";
       $result = mysqli_query($conn, $query);

     if ($result)
     {  
        $alt_msg = "Successfully Added Event!";
...
<body>
<head>
<title> Add Form for Event Calander </title>
...
<br> <br>
  <center>
	<h1><strong style="color:#000033;"> Add Event Here! </strong> </h1><br> <br> </center>
	<div id="ev_w">
	<form method="post" action='event_calander_welfare_add.php'>
	<strong> Event Name: <input type='text' name='ename' required><br><br>
	Event Type: <select name='etype' required>
				<option value='Technical'> Technical </option>
				<option value='Non-Technical'> Non-Technical </option>
				<option value='Cultural'> Cultural </option> 
				<option value='Social'> Social </option>
			</select> <br><br>
	Event Month: <input type='date' name='edate' required><br><br>
	Event Description: <input type='textarea' name='edesc'></strong><br> <br>
  <input type='hidden' value='<?php echo $e_id ?>' name='eid'>
