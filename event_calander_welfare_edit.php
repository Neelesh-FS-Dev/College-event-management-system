...
<html>
<head>
<title> Edit in Event Calander </title>
...
<table>
	...
	while($row = mysqli_fetch_array($result))
	{
		...
		$eid = $row['event_id'];
		echo "<td>" . "<form method='post' action='event_calander_welfare_edit_verify.php'>". "<input type='submit' value='Edit' name='e_edit'>"."<input type='hidden' value='$eid' name='eid'>" . "</form>" ."</td>";
		echo "</tr>";
	}
