...
{
    echo $_SESSION['username'] . "-" . $_SESSION['utype'];
}
?>
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
  ...
  $utype = $_POST["utype"];
  $sql = "SELECT * FROM signup WHERE username='$username' AND password='$password' AND utype='$utype'";
  ...
  if($num == 1)
  {
    ...
    if($utype == 'Student')
    {
        $alt_msg = "Successfully Login!";
        $name = alertmsg($alt_msg);
        echo '<script type="text/javascript">window.location.href = "home_1_student.php"; </script>';
    }
    ...
    if($utype == 'Admin')
    {
        $alt_msg = "Successfully Login!";
        $name = alertmsg($alt_msg);
        echo '<script type="text/javascript">window.location.href = "home_1_admin.php"; </script>';
    }
    ...
    $showError = "Invalid Credentials or User Type";
  }
}
...
<center><h2 style="color:red;"> <span><?php echo $showError; ?> </span></h2> </center> <br>

<br> <br>
<center> <h1> <strong style="color:#000033;">Login to our website </strong> </h1> </center>
<div id="ev_w">
    
      <form action="loggin.php" method="post">
        Username (Email) : <input type="text" name="username" required><br><br>
