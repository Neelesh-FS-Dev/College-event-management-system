...
{
	$e = $_POST['e_name'];
	$query = "SELECT * from event_registration where e_name = '$e'";
...
<center> <h1> <strong style="color:#000033;"> Registration List! </strong></h1> </center><br><br>
