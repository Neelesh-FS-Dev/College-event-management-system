...
{
	$e = $_POST['e_name'];
	$query = "SELECT * from event_volunteers where v_ename = '$e'";
...
<center> <h1> <strong style="color:#000033;"> Volunteers List! </strong></h1> </center><br><br>

<center> <h1> <strong style="color:#000033;"> Event Name: <?php echo $e; ?> </strong></h1> <br><br>

<table>
	<tr>
		<th> Student Name </th>
		<th> Student Roll No </th>
		<th> Student's Post </th>
	</tr>
	<?php
	while($row = mysqli_fetch_array($result))
	{
		?>
		<tr>
			<td> <?php echo $row['v_sname']; ?> </td>
			<td> <?php echo $row['v_rname']; ?> </td>
