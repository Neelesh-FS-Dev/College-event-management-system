...
<html>
    <head>
        ...
        <title>Event List - Registration</title>
...
<center> <h1> <strong style="color:#000033;"> Select on Going Event! </strong></h1> <br><br>
...
<table>
  ...
  while($row = mysqli_fetch_array($result))
  {
    ...
    <tr>
      <td> <?php echo $e;?> </td>
      <td> 
        <form method="post" action= "list_registration_1.php">
            <input type="hidden" name="e_name" value="<?php echo $e;?>">
            <input type="submit" value="<?php echo $e;?>" name="submit" >
            </form>
      </td>
   </tr> 
    <?php
