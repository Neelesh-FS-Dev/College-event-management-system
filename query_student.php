...
<center> <h1><strong style="color:#000033;"> Welcome to Query Forum! </strong> </h1><br> <br> </center>
  <div id="ev_w">
  <form method="post" action="ask_query.php">
      <input type="submit" name="ask" value="Ask a Query">
  </form>
  <form method="post" action="see_query.php">
      <input type="submit" name="see" value="See all Queries">
  </form>
  <form method="post" action="answer_query.php">
      <input type="submit" name="answer" value="Answer a Query">
  </form>
</div>
</body>
</body>
